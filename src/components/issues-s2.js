...
class IssuesS2 extends Component{
    render(){
        return(    
            <Container fluid className="issues-s2 d-flex minh-50vh bg-light align-items-center py-5 border-top border-secondary">
