...
class SubmissionsS1 extends Component{
    render(){
        return(    
            <Container fluid className="submissions-s1 bg-dark d-flex minh-50vh align-items-center py-5">
